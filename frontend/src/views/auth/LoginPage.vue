 ...
 * ======================
 * ORCID authentication login page.
 */
    ...
    >
      <div class="bg-white rounded-2xl shadow-xl p-8">
        ...
        <div class="text-center mb-8">
          ...
          <p class="text-gray-600">Sign in with your ORCID account</p>
        </div>
        ...
        <div class="mt-8 pt-8 border-t border-gray-100">
          <p class="text-xs text-gray-400 text-center">
            ...
            <a href="#" class="text-secondary-600 hover:underline">Terms of Service</a>
            and 
            <a href="#" class="text-secondary-600 hover:underline">Privacy Policy</a>.
          </p>
        </div>
      </div>
